...
### the R script is  DESeq2_analysis_MG_vs_SG_070422.R Ctrl_vd_Infec_MG_analysis_210722 Ctrl_vd_Infec_SG_analysis_210722
...
##### obtain Differential expressed isoforms of multisoform genes (DEMG)
### the R script is DESeq2_analysis_MG_vs_SG_070422.R Ctrl_vd_Infec_MG_analysis_210722.R Ctrl_vd_Infec_SG_analysis_210722.R


### obtain isoforms differentially used
## the code is inIsoform_switch_MG_vs_SG.R and Isoform_switch_Ctrol_vs_Infec.R
...
# AS_mechanism_by_conditions.R and AS_mechanism_by_conditions_CHI_test.R
...
# THE CODE RELATED WITH THIS IS CALLED DEMG_correlation_by_levels_without_overlap.r
...
# preparation and execution Motif_analysis_diffbind_splicing_sites_DUI_DEF_130423.R
### annotation
...
# merge_enhancers_with_DEMG_DUI_def_310123.R
